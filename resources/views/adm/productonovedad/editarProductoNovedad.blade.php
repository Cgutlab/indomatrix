...
<main>
	...
	<div class="container">
		...
		<div class="row">
			...
			{!!Form::model($producto, ['route'=>['productonovedad.update', $producto->id], 'method'=>'PUT', 'files' => true])!!}
            ...
            <option value="{{$categoria->id}}" @if($categoria->id == $producto->id_categorias_novedads) selected @endif>{!!$categoria->titulo!!}</option>
				...
				<div class="row">
					...
					<div class="input-field col s12">
						...
						{!!Form::textarea('extracto', $producto->extracto, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5', ])!!}
