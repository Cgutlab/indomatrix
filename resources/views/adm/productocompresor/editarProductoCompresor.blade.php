...
@section('titulo', 'Editar Producto Compresors')
...
<main>
	...
	<div class="container">
		...
		<div class="row">
			...
			{!!Form::model($producto, ['route'=>['productocompresor.update', $producto->id], 'method'=>'PUT', 'files' => true])!!}
            ...
            <option value="{{$categoria->id}}" @if($categoria->id == $producto->id_categorias_compresors) selected @endif>{!!$categoria->titulo!!}</option>
 ...
 --}}
				...
				<div class="row">
					...
					<div class="input-field col s12">
						...
						{!!Form::text('ruta',$producto->ruta,['class'=>'validate','required'])!!}
