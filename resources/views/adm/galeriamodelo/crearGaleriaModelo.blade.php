...
@section('titulo', 'Crear Galeria Modelo')
...
<main>
	...
	<div class="container">
		...
		<div class="row">
			...
			{!!Form::open(['route'=>'galeriamodelo.store', 'method'=>'POST', 'files' => true])!!}
				...
				<div class="row">
					...
					<div class="file-field input-field col s8">
						...
						<div class="file-path-wrapper">
						    ...
						    {!! Form::text('',null, ['class'=>'file-path validate', 'required', 'placeholder'=>'Recomendado (400px  X  280px)']) !!}
