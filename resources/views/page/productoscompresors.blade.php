...
<div class="col s12 m4" style="position: relative;">
  ...
  <div class="card z-depth-0">
    ...
    <a href="{{$producto->ruta}}" class="naranja fs20 mayus">
        ...
        <img src="{{asset('imagenes/productocompresor/'.$producto->imagen)}}" style="border: 1px solid #DDD;width: 100%; height: 250px;">

    </a>

    </div>

    <div class="card-content cero center-align" style="margin:10px 15px 0px 15px; height: 50px; padding: 0;"> {{-- height --}}
