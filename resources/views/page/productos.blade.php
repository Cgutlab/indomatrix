...
<div class="hide-on-med-and-down cero" style="background: #EBEBEB; border-bottom: 1px solid #DDDDDD;">
  ...
  <div class="container cero" style="width: 82%;">  
    ...
    <div class="row cero">
      ...
      <a href="{{route('textiles')}}" class="gris14 Roboto">
      ...
      <a href="{{route('textil', $categoria->id)}}" class="gris14 Roboto">
...
<div class="col s12 m4" style="position: relative;">
  ...
  <div class="card z-depth-0">
    ...
    <a href="{{route('productot', $producto->id)}}" class="naranja fs20 mayus">
        ...
        <img src="{{asset('imagenes/textil_productos/'.$producto->imagen)}}" style="border: 1px solid #DDD;width: 100%; height: 100%;">
    ...
    <div class="card-content cero center-align" style="margin:10px 15px 0px 15px; height: 180px;"> {{-- height --}}
      ...
      <div class="Roboto fw6 verde1 editorRico cero">{!!($producto->titulo)!!}</div>
