...
@foreach($categorialuminarias as $categorialuminaria)
...
<div class="col s12 m6 l3">
  ...
  <div class="card z-depth-0">
    ...
    <a href="{{route('luminaria', $categorialuminaria->id)}}">
        ...
        <img src="{{('imagenes/luminaria_categorias/'.$categorialuminaria->imagen)}}" style="border: 1px solid #DDD; width: 100%; height: 100%;">
    ...
    <div class="card-content cero center-align Roboto" style="border: 1px solid #DDD; background: #DDD;">
      ...
      <div class="Roboto fw5 fs16 gris13 editorRico">{!!($categorialuminaria->titulo)!!}</div>
